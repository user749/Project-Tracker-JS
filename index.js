...
taskbox.forEach(column => {
    ...
    column.addEventListener("dragend", event => {
        ...
        console.log("This is our custom shit-> " + event.target.dataset.id);
        console.log("This is our custom shit-> " + event.target.parentElement.dataset.id);
        console.log("This is our custom shit-> " + event.target.taskId);
        console.log("This is our custom shit-> " + event.target.task);
